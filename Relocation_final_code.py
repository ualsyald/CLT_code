...
# Load the data
container_df = pd.read_csv('C:/minyeong/input/Initial_7,New_18/Container_ex28.csv')
initial_state_df = pd.read_csv('C:/minyeong/input/Initial_7,New_18/Initial_state_ex28.csv')
